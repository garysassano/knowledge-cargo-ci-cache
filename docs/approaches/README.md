...
| RunsOn sticky disk | Planned experiment after v3.2 upgrade | You want native Cargo-input or target persistence without tar archive serialization. | Disk/inode growth, last-writer behavior, reset policy, EBS cost, and platform migration. | [RunsOn deployment](../deployments/runs-on/README.md#sticky-disk-options) | [canary workflow](../../examples/workflows/runs-on-sticky-disk-canary.yml) |
