...
| [`mr-boxington` vs `sccache`](mr-boxington-vs-sccache.md) | Separates same-job reuse from four fresh-runner Docker trials; records the exact-restore/path-mapping limitation and JSONL data. |
