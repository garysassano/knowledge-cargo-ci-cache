...
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| RunsOn action         | [v2.3.1 sccache setup](https://github.com/runs-on/action/blob/v2.3.1/internal/sccache/sccache.go) is unchanged from the v2.3.0 file reviewed below.                                                           | It still exports backend/wrapper settings without installing or coordinating the compiler-cache lifecycle.                                                                                          |
