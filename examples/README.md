...
| [`runs-on-sccache-canary.yml`](workflows/runs-on-sccache-canary.yml)                             | Trusted-writer S3 `sccache` canary with an ephemeral target, no separate Cargo-input archive, and statistics.           | [`docs/tools/sccache.md`](../docs/tools/sccache.md)                                                                     |
